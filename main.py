...
def test(args, params, model=None):
    ...
    if model is None:
        model = torch.load('/home/FYP/ryu007/YOLOv8-pt/best_baseline.pt', map_location='cuda')['model'].float()
...
#     # Pad the resized image to be [input_size, input_size]
#     top = (input_size - nh) // 2
...
#     # Set model to evaluation mode and forward the image through the model
#     if model is None:
#         model = torch.load('/home/FYP/ryu007/YOLOv8-pt/best_baseline.pt', map_location='cuda')['model'].float()
#     model.eval()
#     model.to(device)
...
#     pred_nms = util.non_max_suppression(pred, 0.3, 0.5)[0]
...
def detect(image_path, model=None, device='cuda', input_size=640):
    ...
    if model is None:
        model_path = '/home/FYP/ryu007/YOLOv8-pt/best_baseline.pt'
